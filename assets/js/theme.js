...
(function() {
    ...
    function createThemeSelector() {
        ...
        // Check if navbar theme toggle already exists
        const navbarToggle = document.querySelector('.theme-toggle-nav');
        if (navbarToggle) {
            // Use navbar toggle instead of creating floating button
            navbarToggle.addEventListener('click', toggleThemeSelector);
        } else {
        ...
        document.addEventListener('click', (e) => {
            ...
            if (selectorEl && !selectorEl.contains(e.target)) {
                // Don't close if clicking navbar toggle or floating button
                if (navbarToggle && navbarToggle.contains(e.target)) return;
